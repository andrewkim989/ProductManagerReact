  ...
  render() {
    return (
      <div id = "home">
        ...
        <img src = {require("./plushies.jpeg")} alt = "plushies"></img>
      </div>
    )
  }
}
    ...
    if (products.length < 1) {
      return (
        <div id = "nope">
          ...
          <img src = {require("./twilightshrug.png")} alt = "shrug"></img>
        </div>
      )
    }
    else {
      for (var i = 0; i < products.length; i++) {
        productClasses.push(<div className = "singleproduct" key = {i}>
          <img src = {products[i].image} alt = ""></img>
          <h4>{products[i].name}</h4>
          <h4>{products[i].price} bits</h4>
